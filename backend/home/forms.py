...
class SignupForm(UserCreationForm):
    ...
    first_name = forms.CharField(max_length=200, label='First name', help_text='Required', widget=forms.TextInput(
        attrs={'placeholder': 'First name', 'class': 'form-group'}))
    last_name = forms.CharField(max_length=200, label='Last Name', help_text='Required', widget=forms.TextInput(
        attrs={'placeholder': 'Last name', 'class': 'input'}))
    password1 = forms.CharField(max_length=200, label='Password', help_text='Required', widget=forms.TextInput(
    ...
    password2 = forms.CharField(max_length=200, label=' Confirm Password', help_text='Required', widget=forms.TextInput(
        attrs={'placeholder': 'Confirm password', 'type': 'password', 'class': 'input', 'id': 'myInput'}))
    username = forms.CharField(max_length=200, label='Username', help_text='Required', widget=forms.TextInput(
